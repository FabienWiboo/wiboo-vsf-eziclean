<template>
  <div class="ezi-product-summary">
    <div class="product-description" v-if="!!product">
      <h1>{{ product.content.titre_du_produit_pour_le_site || product.content.title }}</h1>
      <h2>{{ product.content.sous_titre_du_produit_pour_le_site }}</h2>

      <p class="description-content">
        {{ product.content.phrase_daccroche }}
      </p>

      <p class="price">{{ (product.price || 0) | currency }}</p>
      ...
      <div class="product-buttons">
        ...
        <a href="#accessories" @click="$emit('goToAnchor')" class="to-accessories">{{ $t("accessories") }}</a>
      </div>
    </div>
    <div class="product-carousel">
      ...
      >
        ...
        <template slot="prevButton"
          ><div class="prev-button" @click="playVideo = false">
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <path
                  d="M309 1241 c-30 -30 -39 -47 -39 -72 0 -31 22 -56 247 -281 l248 -248
...
-400 265z"
        ...
        <template slot="nextButton"
          ><div class="next-button" @click="playVideo = false">
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg">
              <g
                transform="translate(0.000000,128.000000) scale(0.100000,-0.100000)"
                fill="#000000"
...
-400 265z"
      ...
      <EziSlider
        ...
        :options="{
          navButtons: false,
          slidesToShow: product.slides.length,
          infinite: false,
          unagile: true,
          dots: false,
        }"
...
export default {
  ...
  computed: {
    sortedSlides() {
      const sortedSlides = this.product.slides;
